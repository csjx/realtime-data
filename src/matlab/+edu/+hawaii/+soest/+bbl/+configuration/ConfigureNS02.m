...
classdef ConfigureNS02
  properties
    ...
    outputDirectory = '/var/www/html/OE/KiloNalu/Data/CTD/NS02/'; % note trailing slash
    ...
    rbnbSinkName = 'MatlabNS02CTDProcessingSink';
