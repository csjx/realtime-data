...
classdef ConfigureNS01
  properties
    ...
    outputDirectory = '/var/www/html/OE/KiloNalu/Data/CTD/NS01/'; % note trailing slash
    ...
    rbnbSinkName = 'MatlabNS01CTDProcessingSink';
