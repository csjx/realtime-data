  ...
  methods % functions available from this class
         ...
         for figureNumber = 1:length(self.configuration.timeSeriesFigures)
           try
             ...
             figureXAxisTickStep = ...
               str2num( ...
                 char( ...
                 self.configuration.timeSeriesFigures{figureNumber}(5) ...
                 ) ...
               );
             
             % Get the figure tick formats for each plot
             plotTickFormats = ...
                   self.configuration.timeSeriesFigures{figureNumber}(6);
             
             % Get the graphic markers for each plot
             graphicMarkers = ...
               self.configuration.timeSeriesFigures{figureNumber}(7);
             
             % Get the graphic marker sizes for each plot
             graphicMarkersizes = ...
               self.configuration.timeSeriesFigures{figureNumber}(8);
             
             % Get the graphic markers colors for each plot
             graphicMarkerColors = ...
               self.configuration.timeSeriesFigures{figureNumber}(9);
             
             % Get the includeMovingAverage boolean value
             includeMovingAverage = ...
               str2num( ...
                 char( ...
                   self.configuration.timeSeriesFigures{figureNumber}(10) ...
                 ) ...
               );
             ...
             movingAverageDuration = ...
               str2num( ...
                 char( ...
                   self.configuration.timeSeriesFigures{figureNumber}(11) ...
                 ) ...
               );

             % Get the moving average line color
             movingAverageLineColor = ...
               self.configuration.timeSeriesFigures{figureNumber}(12);
             
             % Get the moving average line width
             movingAverageLineWidth = ...
               str2num( ...
                 char( ...
                   self.configuration.timeSeriesFigures{figureNumber}(13) ...
                 ) ...
               );
             ...
             if ( self.configuration.exportFigures )
               ...
               self.export(timesSeriesHandle, outputFormat, figureNameSuffix);
    ...
    function value = createTimesSeriesFigure(self, ...
      ...
      for plotNumber = 1:numberOfPlots
        ...
        xlim([(max(x) - (figureDuration/60/60/24)) max(x)]);        
        ...
        xtick = (max(x) - (figureDurationInDays):figureXAxisTickStep:max(x));
        if ( figureDurationInDays <= 1 )
          xticklabel = datestr(xtick,'ddmmmyy HH:MM');
        else  
