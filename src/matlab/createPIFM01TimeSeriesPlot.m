...
'rbnbSinkName'        , 'MatlabPIFM01_001CTDXXXXR00PlottingSink'          , ...
'rbnbSource'          , 'PIFM01_001CTDXXXXR00'                            , ...
...
set(configuration,                                                          ...
'sensorLatitude', 6.960399                                                , ...
'sensorLongitude', 158.20869                                                ...
);
...
'timeSeriesFigures'   , {                                              ...
                         % 1-day plot
                         {'Pohnpei Lagoon, Kolonia, Micronesia, Daily Water Quality'  , ... % titlePrefix
                         ...
                         % 3-day plot
                         {'Pohnpei Lagoon, Kolonia, Micronesia, 3-day Water Quality'  , ... % titlePrefix
                          '02-26-2010 10:00:00'                        , ... % figure start in UTC
                          '259200'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 7-day plot
                         {'Pohnpei Lagoon, Kolonia, Micronesia, Weekly Water Quality'  , ... % titlePrefix
                          '02-26-2010 10:00:00'                        , ... % figure start in UTC
                          '604800'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Pohnpei Lagoon, Kolonia, Micronesia, Monthly Water Quality'  , ... % titlePrefix
                         '02-26-2010 10:00:00'                        , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
...
dataFileHandle =                                      ...
  fopen([PIMI01ctdProcessor.configuration.baseDirectory ...
        'test/data/PIFM01/PIFM01_001CTDXXXXR00_20100507171614.txt'], 'r');
