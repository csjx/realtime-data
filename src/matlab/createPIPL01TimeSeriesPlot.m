...
'timeSeriesFigures'   , {                                              ...
                         % 3-day plot
                         {'Palau International Coral Reef Center, Palau, 3-day Water Quality'  , ... % titlePrefix
                         ...
                         % 7-day plot
                         {'Palau International Coral Reef Center, Palau, Weekly Water Quality'  , ... % titlePrefix
                          '02-26-2010 10:00:00'                        , ... % figure start in UTC
                          '604800'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Palau International Coral Reef Center, Palau, Monthly Water Quality'  , ... % titlePrefix
                         '02-26-2010 10:00:00'                         , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 60-day plot
                         {'Palau International Coral Reef Center, Palau, 60 Day Water Quality'  , ... % titlePrefix
                         '02-26-2010 10:00:00'                         , ... % figure start in UTC
                          '5184000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
...
set(PIPL01ctdProcessor, 'processTime', now());

% get the data from a local file in the test directory
dataFileHandle =                                      ...
  fopen([PIPL01ctdProcessor.configuration.baseDirectory ...
        'test/data/PIPL01/PIPL01_001CTDXXXXR00_20100719180044.all.txt'], 'r');
PIPL01ctdProcessor.dataString = fread(dataFileHandle, '*char');
fclose(dataFileHandle);

% parse the data string into a cell array used to create graphics
PIPL01ctdProcessor.dataCellArray = PIPL01ctdProcessor.parse();
...
try
  for derivedVariableNumber = 1:length(PIPL01ctdProcessor.configuration.derivedVariableNames)
    PIPL01ctdProcessor.dataCellArray{length(PIPL01ctdProcessor.dataCellArray) + 1} = ...
      createDerivedVariable(PIPL01ctdProcessor, ...
        PIPL01ctdProcessor.configuration.derivedVariableNames{ ...
...
if ( PIPL01ctdProcessor.configuration.createFigures )
  if ( strcmp(PIPL01ctdProcessor.configuration.currentFigureType, 'timeSeries') )
    figurePropertiesArray = PIPL01ctdProcessor.configuration.timeSeriesFigures;
   
  elseif ( strcmp(PIPL01ctdProcessor.configuration.currentFigureType, 'temperatureSalinity') )
    figurePropertiesArray = PIPL01ctdProcessor.configuration.tsFigures;
  else
  ...
  for figureNumber = 1:length(figurePropertiesArray)
    try
      ...
      if ( strcmp(PIPL01ctdProcessor.configuration.currentFigureType, 'timeSeries') )
      figureHandle =                  ...
        PIPL01ctdProcessor.createTimesSeriesFigure( ...
          figureTitlePrefix         , ...
          figureStartDate           , ...
          figureDuration            , ...
          figureYAxisVariables      , ...
      ...
      elseif ( strcmp(PIPL01ctdProcessor.configuration.currentFigureType, 'temperatureSalinity') )
        figureHandle =                  ...
          PIPL01ctdProcessor.createTSFigure(          ...
            figureTitlePrefix         , ...
            figureStartDate           , ...
            figureDuration            , ...
            figureYAxisVariables      , ...
      ...
      if ( PIPL01ctdProcessor.configuration.exportFigures )
        % call the export method
        outputFormat = '';
        figureNameSuffix = [num2str(figureDuration/60/60/24) 'day'];
        PIPL01ctdProcessor.export(figureHandle, outputFormat, figureNameSuffix);
        % PIPL01ctdProcessor.export(TSHandle);
      end
