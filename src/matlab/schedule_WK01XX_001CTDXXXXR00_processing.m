...
'timeSeriesFigures'   , {                                              ...
                          % Figure 1                                 
                          {'Waikiki , 1 Day Water Quality'           , ... % titlePrefix
                           '86400'                                   , ... % duration
                         ...
                         % Figure 2                                  
                         {'Waikiki, 3 Day Water Quality'             , ... % titlePrefix
                          '259200'                                   , ... % duration
                          {'temperature'                             , ... % xAxisVars
                           'salinity'                                , ... 
                           'depth'}                                  , ... 
                         ...
                         % Figure 3                                  
                         {'Waikiki, 7 Day Water Quality'             , ... % titlePrefix
                          '604800'                                   , ... % duration
                          {'temperature'                             , ... % xAxisVars
                           'salinity'                                , ... 
                           'depth'}                                  , ... 
                         ...
                         % Figure 4                                  
                         {'Waikiki, 21 Day Water Quality'            , ... % titlePrefix
                          '1814400'                                  , ... % duration
                          {'temperature'                             , ... % xAxisVars
                           'salinity'                                , ... 
                           'depth'}                                  , ... 
