% schedule_AW01XX_002CTDXXXXR00_processing 
...
'outputDirectory'     , '/var/www/html/OE/KiloNalu/Data/CTD/AW01XX_002CTDXXXXR00/' , ...
...
'rbnbSinkName'        , 'MatlabAW01XX_002CTDXXXXR00ProcessingSink'        , ...
...
NS01ctdProcessor = DataProcessor(configuration);
...
set(NS01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                    ...
        ...
        'period',                                      ...
        NS01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                               ...
        'fixeddelay'));
startat(NS01ctdProcessor.timerObject, NS01ctdProcessor.timerStartTime);
