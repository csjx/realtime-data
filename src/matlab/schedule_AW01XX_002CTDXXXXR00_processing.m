...
% createPacIOOSFigures - is a flag to either create or not create PacIOOS figures
...
set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       % Figure 1  (7 day plot)
                       {'Nearshore Sensor, Waikiki Yacht Club (NS01), 7 day',  ... %Title prefix
                        '7'}                                                ;  ... %Duration in days
                       % Figure 2  (30 day plot)
                        {'Nearshore Sensor, Waikiki Yacht Club (NS01), 30 day',... %Title prefix
                        '30'}                                                ; ... %Duration in days
                             }                                                 ...
                              )                                              ;
