% schedule_PIGM01_002CTDX002R00_processing 
...
%  
% $HeadURL: https://bbl.ancl.hawaii.edu/projects/bbl/trunk/src/matlab/schedule_PIPL01_001CTDXXXXR00_processing.m $
% $LastChangedDate: 2013-07-24 14:42:02 -1000 (Wed, 24 Jul 2013) $
...
'outputDirectory'     , '/data/processed/figures/CTD/PIGM01/'             , ...
...
'rbnbSinkName'        , 'MatlabPIGM01_002CTDX002R00PlottingSink'          , ...
'rbnbSource'          , 'PIGM01_002CTDX002R00'                            , ...
'rbnbChannel'         , 'DecimalASCIISampleData'                          , ...
'archiveDirectory'    , 'pacioos'                                         , ...
'dataStartDate'       , '08-01-2014 00:00:00'                             , ...
'sensorTimeOffset'    , +10                                               , ...
'duration'            , 'full'                                            , ...
'check_last'          , 'yes'                                             , ...
'reference'           , 'newest'                                            ...
...
set(configuration,                                                          ...
'sensorLatitude', 13.420817                                               , ...
'sensorLongitude', 144.785917                                               ...
);
...
set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       % Figure 1  (7 day plot)
        %               {{'Nearshore Sensor, Pago Bay, Guam (NS15), 7 day'},    ... %Title prefix
        %                {'7'}                                               ,  ... %Duration in days
        %                {'.eps'}                                               ... %Output format
        %                }                                                    ; ...
                       % Figure 2  (30 day plot)
        %               {{'Nearshore Sensor, Pago Bay, Guam (NS15), 30 day'}  , ... %Title prefix
        %                {'30'}                                               , ... %Duration in days
        %                {'.eps'}                                               ... %Output format
        %                }                                                    ; ...
                       % Figure 3  (monthly plot)
                       {{'Nearshore Sensor, Pago Bay, Guam (NS15)'}          , ... %Title prefix
                        {'monthly'}                                          , ...
                        {'.eps'}                                               ...
                        }                                                      ...
                       }                                                       ...
...
'timeSeriesFigures'   , {                                              ...
                         % 7-day plot
                         {'Pago Bay, Guam, 7 Day Water Quality'        , ... % titlePrefix
                         ...
                         % 10-day plot
                         {'Pago Bay, Guam, 10 Day Water Quality'       , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '864000'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Pago Bay, Guam, 30 Day Water Quality'       , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
...
PIGM01ctdProcessor = DataProcessor(configuration);

PIGM01ctdProcessor.process()

% schedule the processing
% set the timer start time based on the timer interval.
set(PIGM01ctdProcessor, 'timerStartTime', PIGM01ctdProcessor.configuration.timerInterval);

% set the timer object instance
set(PIGM01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                        ...
        'PIGM01ctdProcessor.process',                      ...
        'period',                                          ...
        PIGM01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                   ...
        'fixeddelay'));
startat(PIGM01ctdProcessor.timerObject, PIGM01ctdProcessor.timerStartTime);
