...
%                             Set to 'monthly' to produce plots of exactly
%                             one month duration  (eg. Apr 1 - Apr 30)

set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       % Figure 1  (7 day plot)
                        {'Nearshore Sensor, Hawaii Yacht Club (NS02), 7 day' , ... %Title prefix
                         '7'}                                                ; ... %Duration in days
                       % Figure 2  (30 day plot)
                        {'Nearshore Sensor, Hawaii Yacht Club (NS02), 30 day', ... %Title prefix
                         '30'}                                               ; ... %Duration in days
                       % Figure 3  (monthly plot)
                        {'Nearshore Sensor, Hawaii Yacht Club (NS02)'        , ... %Title prefix
                         'monthly'}                                            ...
                       }                                                       ...
    )                                                                        ;
...
set(NS02ctdProcessor, 'timerStartTime', NS02ctdProcessor.configuration.timerInterval);

% set the timer object instance
set(NS02ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                    ...
        'NS02ctdProcessor.process',                      ...
        'period',                                      ...
        NS02ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                               ...
        'fixeddelay'));
startat(NS02ctdProcessor.timerObject, NS02ctdProcessor.timerStartTime);
