...
set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       ...
                       % Figure 2  (21 day plot)
                        {'Nearshore Sensor, Pohnpei, FSM (NS06), 21 day',... %Title prefix
                        '21'}                                                ; ... %Duration in days
                             }                                                 ...
                              )                                              ;
...
'timeSeriesFigures'   , {                                              ...
                         % 1-day plot
                         {'Kolonia, Pohnpei, Federated States of Micronesia, Daily Water Quality'  , ... % titlePrefix
                         ...
                         % 3-day plot
                         {'Kolonia, Pohnpei, Federated States of Micronesia, 3-day Water Quality'  , ... % titlePrefix
                          '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '259200'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 7-day plot
                         {'Kolonia, Pohnpei, Federated States of Micronesia, Weekly Water Quality'  , ... % titlePrefix
                          '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '604800'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Kolonia, Pohnpei, Federated States of Micronesia, Monthly Water Quality'  , ... % titlePrefix
                         '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 60-day plot
                         {'Kolonia, Pohnpei, Federated States of Micronesia, 60 Day Water Quality'  , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '5184000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
