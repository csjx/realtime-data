% schedule_KN0101_010SBEX010R00_processing 
...
'outputDirectory'     , '/var/www/html/OE/KiloNalu/Data/CTD/KN0101_010SBEX010R00/' , ...
...
'rbnbSinkName'        , 'MatlabKN0101_010SBEX010R00ProcessingSink'        , ...
...
'dataVariableNames'   , {'serialNumber'                                   , ...
                         'temperature'                                    , ...
                         'conductivity'                                   , ...
                         'pressure'                                       , ...
                         'depth'                                          , ...
...
sbe37Processor = DataProcessor(configuration);

% schedule the processing
% set the timer start time based on the timer interval.
set(sbe37Processor, 'timerStartTime', sbe37Processor.configuration.timerInterval);

% set the timer object instance
set(sbe37Processor, 'timerObject',                     ...
  timer('TimerFcn',                                    ...
        'sbe37Processor.process',                      ...
        'period',                                      ...
        sbe37Processor.configuration.timerInterval*60, ...
        'executionmode',                               ...
        'fixeddelay'));
