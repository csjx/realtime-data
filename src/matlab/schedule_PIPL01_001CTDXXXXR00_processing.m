...
set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       ...
                       % Figure 2  (21 day plot)
                        {{'Nearshore Sensor, Koror, Palau (NS08), 30 day'}   , ... %Title prefix
                        {'30'}                                               , ... %Duration in days
                        {'.eps'}                                               ... %Output format
                        }                                                    ; ...
                        % Figure 3  (monthly plot)
                       {{'Nearshore Sensor, Koror, Palau (NS08)'}            , ... %Title prefix
                        {'monthly'}                                          , ...
                        {'.eps'}                                               ...
                        }                                                      ...
                       }                                                       ...
...
'timeSeriesFigures'   , {                                              ...
                         % 7-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, 7 Day Water Quality'  , ... % titlePrefix
                         ...
                         % 10-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, 10 Day Water Quality'  , ... % titlePrefix
                         '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '864000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, 30 Day Water Quality'  , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
