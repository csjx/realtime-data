% schedule_PIPL01_001CTDXXXXR00_processing 
...
'outputDirectory'     , '/data/processed/figures/CTD/PIPL01/'             , ...
...
'rbnbSinkName'        , 'MatlabPIPL01_001CTDXXXXR00PlottingSink'          , ...
'rbnbSource'          , 'PIPL01_001CTDXXXXR00'                            , ...
...
set(configuration,                                                          ...
'sensorLatitude', 7.33842                                                 , ...
'sensorLongitude', 134.46630                                                ...
);
...
set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       % Figure 1  (7 day plot)
                       {'Nearshore Sensor, Koror, Palau (NS08), 7 day',  ... %Title prefix
                        '7'}                                                ;  ... %Duration in days
                       % Figure 2  (21 day plot)
                        {'Nearshore Sensor, Koror, Palau (NS08), 21 day',... %Title prefix
                        '21'}                                                ; ... %Duration in days
                             }                                                 ...
                              )                                              ;
...
'timeSeriesFigures'   , {                                              ...
                         % 1-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, Daily Water Quality'  , ... % titlePrefix
                         ...
                         % 3-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, 3-day Water Quality'  , ... % titlePrefix
                          '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '259200'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 7-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, Weekly Water Quality'  , ... % titlePrefix
                          '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '604800'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, Monthly Water Quality'  , ... % titlePrefix
                         '06-30-2010 00:00:00'                        , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 60-day plot
                         {'Palau International Coral Reef Center, Koror, Palau, 60 Day Water Quality'  , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '5184000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
...
PIPL01ctdProcessor = DataProcessor(configuration);

% schedule the processing
% set the timer start time based on the timer interval.
set(PIPL01ctdProcessor, 'timerStartTime', PIPL01ctdProcessor.configuration.timerInterval);

% set the timer object instance
set(PIPL01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                        ...
        'PIPL01ctdProcessor.process',                      ...
        'period',                                          ...
        PIPL01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                   ...
        'fixeddelay'));
startat(PIPL01ctdProcessor.timerObject, PIPL01ctdProcessor.timerStartTime);
