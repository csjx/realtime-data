...
% dataStartDate     - is the start date in UTC(mm-dd-yyyy HH:MM:SS) that the 
...
'rbnbSinkName'        , 'MatlabWK02XX_001CTDXXXXR00PlottingSink'          , ...
...
'timeSeriesFigures'   , {                                              ...
                         % 3-day plot
                         {'Waikiki Beach (NS04), 3 Day Water Quality'  , ... % titlePrefix
                         ...
                         % 10-day plot
                         {'Waikiki Beach (NS04), 10 Day Water Quality' , ... % titlePrefix
