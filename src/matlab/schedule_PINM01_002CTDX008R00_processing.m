% schedule_PINM01_002CTDX008R00_processing 
...
'outputDirectory'     , '/data/processed/figures/CTD/PINM01/'             , ...
...
'rbnbSinkName'        , 'MatlabPINM01_002CTDX008R00PlottingSink'          , ...
'rbnbSource'          , 'PINM01_002CTDX008R00'                            , ...
...
set(configuration,                                                          ...
'sensorLatitude', 15.156667                                               , ...
'sensorLongitude', 145.769444                                               ...
);
...
set( configuration,                                                               ...
    'PacIOOSFigures', {                                                           ...
                       % Figure 1  (7 day plot)
                       {{'Nearshore Sensor, Lao Lao Bay, Saipan (NS11), 7 day'} , ... %Title prefix
                        {'7'}                                                   , ... %Duration in days
                        {'.eps'}                                                  ... %Output format
                        }                                                       ; ...
                       % Figure 2  (30 day plot)
                       {{'Nearshore Sensor, Lao Lao Bay, Saipan (NS11), 30 day'}, ... %Title prefix
                        {'30'}                                                  , ... %Duration in days
                        {'.eps'}                                                  ... %Output format
                        }                                                       ; ...
                       % Figure 3  (monthly plot)
                       {{'Nearshore Sensor, Lao Lao Bay, Saipan  (NS11)'}       , ... %Title prefix
...
set(PINM01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                        ...
        'PINM01ctdProcessor.process',                      ...
        'period',                                          ...
        PINM01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                   ...
        'fixeddelay'));
startat(PINM01ctdProcessor.timerObject, PINM01ctdProcessor.timerStartTime);
