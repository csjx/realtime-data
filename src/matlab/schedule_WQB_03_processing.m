% schedule_WQB03_test_processing 
...
'outputDirectory'     , '/data/processed/figures/CTD/WQB03/'              , ...
...
set( configuration,                                                         ...
'rbnbServer'          , 'LOBOViz'                                         , ...
'rbnbSinkName'        , 'MatlabWQB_03PlottingSink'                        , ...
'rbnbSource'          , 'WQB_03'                                          , ...
'rbnbChannel'         , 'DecimalASCIISampleData'                          , ...
'dataStartDate'       , '12-18-2010 02:00:00'                             , ... % UTC
'sensorTimeOffset'    , -10                                               , ...
'duration'            ,  2764800                                          , ...
'reference'           , 'newest'                                            ...
);                                                                        
...
set( configuration,                                                         ...
'dataFormatString'    , '%s %f %f %f %f %f %f %f %f'             , ...
'fieldDelimiter'      , '\t'                                              , ...
'numberOfHeaderLines' , '0'                                               , ...
'instrumentSampleRate', 15                                                , ...
'dataVariableNames'   , {'datetime'                                       , ...
                         'CDOM'                                           , ...
                         'chlorophyll'                                    , ...
                         'nitrate'                                        , ...
...
'dataVariableUnits'   , {'yyyy-mm-dd HH:MM:SS'                            , ...
                         'QSDE'                                           , ...
                         '\mug/L'                                         , ...
                         '\muM'                                           , ...
                         'mL/L'                                           , ...
...
%set(configuration,                                                          ...
%'sensorLatitude', 19.8631                                               , ...
%'sensorLongitude', -155.9294                                               ...
%);
...
set( configuration,                                      ...
    'PacIOOSFigures', {                                  ...
                       % Figure 1  (7 day plot)
                       {{'Water Quality Buoy, Kiholo Bay (WQB03), 7 day'}, ... %Title prefix
                        {'7'}                          , ... %Duration in days
                        {'.eps'}                         ... %Output format
                        }                              ; ...
                       % Figure 2  (21 day plot)
                       {{'Water Quality Buoy, Kiholo Bay (WQB03), 30 day'}, ... %Title prefix
                        {'30'}                         , ... %Duration in days
                        {'.eps'}                         ... %Output format
                        }                              ; ...
                       % Figure 3  (monthly plot)
                        {{'Water Quality Buoy, Kiholo Bay (WQB03)'}, ... %Title prefix
...
'timeSeriesFigures'   , {                                              ...
                         % 7-day plot
                         {'Kiholo Bay 7 Day Water Quality'       , ... % titlePrefix
                         ...
                         % 30-day plot
                         {'Kiholo Bay 30 Day Water Quality'      , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ...
...
WQB03Processor = DataProcessor(configuration);

% schedule the processing
% set the timer start time based on the timer interval.
set(WQB03Processor, 'timerStartTime', WQB03Processor.configuration.timerInterval);

% set the timer object instance
set(WQB03Processor, 'timerObject',                         ...
  timer('TimerFcn',                                        ...
        'WQB03Processor.process',                          ...
        'period',                                          ...
        WQB03Processor.configuration.timerInterval*60,     ...
        'executionmode',                                   ...
        'fixeddelay'));
startat(WQB03Processor.timerObject, WQB03Processor.timerStartTime);
