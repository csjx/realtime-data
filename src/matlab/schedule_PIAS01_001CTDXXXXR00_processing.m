% schedule_PIAS01_001CTDXXXXR00_processing 
...
'outputDirectory'     , '/data/processed/figures/CTD/PIAS01/'             , ...
...
set(PIAS01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                        ...
        'PIAS01ctdProcessor.process',                      ...
        'period',                                          ...
        PIAS01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                   ...
        'fixeddelay'));
startat(PIAS01ctdProcessor.timerObject, PIAS01ctdProcessor.timerStartTime);
