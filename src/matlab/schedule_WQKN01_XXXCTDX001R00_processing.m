...
'outputDirectory'     , '/data/processed/figures/CTD/WQKN01/'             , ...
...
'dataStartDate'       , '05-08-2010 00:00:00'                             , ...
'sensorTimeOffset'    , -10                                               , ...
'duration'            ,  2764800                                          , ...
'reference'           , 'newest'                                            ...
);                                                                        
...
'timeSeriesFigures'   , {                                              ...
                         % 7-day plot
                         {'Kilo Nalu  (WQBKN) 7 Day Water Quality'     , ... % titlePrefix
                         ...
                         % 30-day plot
                         {'Kilo Nalu  (WQBKN) 30 Day Water Quality'    , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ...
...
set(WQKN01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                        ...
        'WQKN01ctdProcessor.process',                      ...
        'period',                                          ...
        WQKN01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                   ...
        'fixeddelay'));
