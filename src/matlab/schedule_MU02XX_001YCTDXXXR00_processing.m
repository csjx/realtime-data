% schedule_MU02XX_001YCTDXXXR00_processing 
...
'outputDirectory'     , '/data/processed/figures/CTD/MU02/'               , ...
...
'rbnbSinkName'        , 'MatlabMU02XX_001YCTDXXXR00PlottingSink'          , ...
'rbnbSource'          , 'MU02XX_001YCTDXXXR00'                            , ...
'rbnbChannel'         , 'DecimalASCIISampleData'                          , ...
'archiveDirectory'    , 'maui'                                            , ...
'dataStartDate'       , '07-18-2014 14:21:00'                             , ...
'sensorTimeOffset'    , -10                                               , ...
'duration'            , 'full'                                            , ...
'check_last'          , 'yes'                                             , ...
'reference'           , 'newest'                                            ...
...
% ignoreMultipleDelims - tells the parsing function to treat multiple delimiters as one
...
set( configuration,                                                   ...
    'PacIOOSFigures', {                                               ...
                       % Figure 1  (7 day plot)
           %            {{'Nearshore Sensor, Kahului Harbor, 7 day'} , ... %Title prefix
           %             {'7'}                                       , ... %Duration in days
           %             {'.eps'}                                      ... %Output format
           %             }                                           ; ...
                       % Figure 2  (21 day plot)
           %            {{'Nearshore Sensor, Kahului Harbor, 30 day'}, ... %Title prefix
           %             {'30'}                                      , ... %Duration in days
           %             {'.eps'}                                      ... %Output format
           %             }                                           ; ...
...
MU02ctdProcessor = DataProcessor(configuration);

%keyboard
MU02ctdProcessor.process()

% schedule the processing
% set the timer start time based on the timer interval.
set(MU02ctdProcessor, 'timerStartTime', MU02ctdProcessor.configuration.timerInterval);

% set the timer object instance
set(MU02ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                      ...
        'MU02ctdProcessor.process',                      ...
        'period',                                        ...
        MU02ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                 ...
        'fixeddelay'));
startat(MU02ctdProcessor.timerObject, MU02ctdProcessor.timerStartTime);