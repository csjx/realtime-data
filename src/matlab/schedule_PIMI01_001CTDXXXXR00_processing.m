% schedule_PIMI01_001CTDXXXXR00_processing 
...
%  
% $HeadURL: https://bbl.ancl.hawaii.edu/projects/bbl/trunk/src/matlab/schedule_PIMI01_001CTDXXXXR00_processing.m $
% $LastChangedDate: 2013-07-24 15:40:08 -1000 (Wed, 24 Jul 2013) $
...
'outputDirectory'     , '/data/processed/figures/CTD/PIMI01/'             , ...
...
set(configuration,                                                          ...
'sensorLatitude', 7.106022                                                 , ...
'sensorLongitude', 171.372583                                                ...
);
...
set( configuration,                                                            ...
    'PacIOOSFigures', {                                                        ...
                       % Figure 1  (7 day plot)
   %                    {{'Nearshore Sensor, Majuro Atoll, RMI (NS07), 7 day'}, ... %Title prefix
   %                     {'7'}                                                , ... %Duration in days
   %                     {'.eps'}                                               ... %Output format
   %                     }                                                    ; ...
                       % Figure 2  (30 day plot)
   %                    {{'Nearshore Sensor, Majuro Atoll, RMI (NS07), 30 day'},... %Title prefix
   %                     {'30'}                                               , ... %Duration in days
   %                     {'.eps'}                                               ... %Output format
   %                     }                                                    ; ...
                       % Figure 3  (monthly plot)
                       {{'Nearshore Sensor, Majuro Atoll, RMI (NS07)'}       , ... %Title prefix
                        {'monthly'}                                          , ...
                        {'.eps'}                                               ...
                        }                                                      ...
                       }                                                       ...
...
'timeSeriesFigures'   , {                                              ...
                         % 7-day plot
                         {'Majuro Atoll, RMI, 7 Day Water Quality'     , ... % titlePrefix
                         ...
                         % 10-day plot
                         {'Majuro Atoll, RMI, 10 Day Water Quality'    , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '864000'                                     , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
                         ...
                         % 30-day plot
                         {'Majuro Atoll, RMI, 30 Day Water Quality'    , ... % titlePrefix
                         '06-30-2010 00:00:00'                         , ... % figure start in UTC
                          '2592000'                                    , ... % duration
                          {'temperature'                               , ... % xAxisVars
                           'salinity'                                  , ... 
...
% Start the Processor
PIMI01ctdProcessor.process() 

% schedule the processing
% set the timer start time based on the timer interval.
set(PIMI01ctdProcessor, 'timerStartTime', PIMI01ctdProcessor.configuration.timerInterval);

% set the timer object instance
set(PIMI01ctdProcessor, 'timerObject',                     ...
  timer('TimerFcn',                                        ...
        'PIMI01ctdProcessor.process',                      ...
        'period',                                          ...
        PIMI01ctdProcessor.configuration.timerInterval*60, ...
        'executionmode',                                   ...
        'fixeddelay'));
startat(PIMI01ctdProcessor.timerObject, PIMI01ctdProcessor.timerStartTime);
