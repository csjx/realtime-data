  ...
  public static void main(String[] args){
    ...
    if (args.length != 1) {
      ...
      try {
        ...
        AdamParser adamParser = new AdamParser(packetBuffer);
        
        // Set up a simple logger that logs to the console
        PropertyConfigurator.configure(adamParser.getLogConfigurationFile());
        
        logger.info("loopID:                         " + adamParser.getLoopID());
        logger.info("barTrend:                       " + adamParser.getBarTrend());
        logger.info("barTrendAsString:               " + adamParser.getBarTrendAsString());
        logger.info("packetType:                     " + adamParser.getPacketType());
        logger.info("nextRecord:                     " + adamParser.getNextRecord());
        logger.info("barometer:                      " + adamParser.getBarometer());
        logger.info("insideTemperature:              " + adamParser.getInsideTemperature());
        logger.info("insideHumidity:                 " + adamParser.getInsideHumidity());
        logger.info("outsideTemperature:             " + adamParser.getOutsideTemperature());
        logger.info("windSpeed:                      " + adamParser.getWindSpeed());
        logger.info("tenMinuteAverageWindSpeed:      " + adamParser.getTenMinuteAverageWindSpeed());
        logger.info("windDirection:                  " + adamParser.getWindDirection());
        logger.info("extraTemperatures:              " + Arrays.toString(adamParser.getExtraTemperatures()));
        logger.info("soilTemperatures:               " + Arrays.toString(adamParser.getSoilTemperatures()));
        logger.info("leafTemperatures:               " + Arrays.toString(adamParser.getLeafTemperatures()));
        logger.info("outsideHumidity:                " + adamParser.getOutsideHumidity());
        logger.info("extraHumidities:                " + Arrays.toString(adamParser.getExtraHumidities()));
        logger.info("rainRate:                       " + adamParser.getRainRate());
        logger.info("uvRadiation:                    " + adamParser.getUvRadiation());
        logger.info("solarRadiation:                 " + adamParser.getSolarRadiation());
        logger.info("stormRain:                      " + adamParser.getStormRain());
        logger.info("currentStormStartDate:          " + adamParser.getCurrentStormStartDate());
        logger.info("dailyRain:                      " + adamParser.getDailyRain());
        logger.info("monthlyRain:                    " + adamParser.getMonthlyRain());
        logger.info("yearlyRain:                     " + adamParser.getYearlyRain());
        logger.info("dailyEvapoTranspiration:        " + adamParser.getDailyEvapoTranspiration());
        logger.info("monthlyEvapoTranspiration:      " + adamParser.getMonthlyEvapoTranspiration());
        logger.info("yearlyEvapoTranspiration:       " + adamParser.getYearlyEvapoTranspiration());
        logger.info("soilMoistures:                  " + Arrays.toString(adamParser.getSoilMoistures()));
        logger.info("leafWetnesses:                  " + Arrays.toString(adamParser.getLeafWetnesses()));
        logger.info("insideAlarm:                    " + adamParser.getInsideAlarm());
        logger.info("rainAlarm:                      " + adamParser.getRainAlarm());
        logger.info("outsideAlarms:                  " + adamParser.getOutsideAlarms());
        logger.info("extraTemperatureHumidityAlarms: " + adamParser.getExtraTemperatureHumidityAlarms());
        logger.info("soilLeafAlarms:                 " + adamParser.getSoilLeafAlarms());
        logger.info("transmitterBatteryStatus:       " + adamParser.getTransmitterBatteryStatus());
        logger.info("consoleBatteryVoltage:          " + adamParser.getConsoleBatteryVoltage());
        logger.info("forecastIconValues:             " + adamParser.getForecastAsString());
        logger.info("forecastRuleNumber:             " + adamParser.getForecastRuleNumberAsString());
        logger.info("timeOfSunrise:                  " + adamParser.getTimeOfSunrise());
        logger.info("timeOfSunset:                   " + adamParser.getTimeOfSunset());
        logger.info("recordDelimiter:                " + adamParser.getRecordDelimiterAsHexString());
        logger.info("crcChecksum:                    " + adamParser.getCrcChecksum());
