 ...
 *    Purpose: A class that represents the ensemble Status Profile
...
/**
 * A class that represents the Status Profile of data produced by
 * an RDI 1200kHz Workhorse Acoustic Doppler Current Profiler in the
 * default PD0 format.
 */
public final class EnsembleStatusProfile {

    /**
     * Constructor.  This method populates the Status Profile fields from
     ...
     * @param ensemble the ensembleHeader that contains the ensemble header data
     */
    public EnsembleStatusProfile(ByteBuffer ensembleBuffer,
                                 Ensemble ensemble) {
