 ...
 *    Purpose: A class that represents the ensemble Bottom Track 
 ...
 *  default PD0 format. 
 */
public final class EnsembleBottomTrack {

  /**
    *  Constructor.  This method populates the Bottom Track fields from 
   ...
   */
  public EnsembleBottomTrack( ByteBuffer ensembleBuffer, 
                              Ensemble ensemble ) {
