...
# @ 192.168.100.60:3333, reading from the source named 'KN0101_010TCHNXXXR00' and the 
# data channel 'DecimalASCIISampleData'.  The client is also setting the sink 
# name to be 'KN0101_0101TCHNXXXR00_DecimalASCIISampleData_FileArchiver', and is
# setting the archive directory to be '
# '/data/rbnb/KN0101_0101TCHNXXXR00/DecimalASCIISampleData'.  The sink client
...
java edu.hawaii.soest.kilonalu.utilities.FileArchiverSink\
 -s 192.168.100.60\
 -p 3333\
 -n KN0101_010TCHNXXXR00\
 -c DecimalASCIISampleData\
 -I hourly\
 -k KN0101_010TCHNXXXR00_DecimalASCIISampleData_FileArchiver\
 -d /data/kilonalu/KN0101_010TCHNXXXR00/DecimalASCIISampleData
