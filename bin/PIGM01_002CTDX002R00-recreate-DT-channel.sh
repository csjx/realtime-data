#!/bin/bash
BBL_HOME=/Ross/Projects/Kilo_Nalu/bbl/trunk/;
export CLASSPATH=\
...
export SOURCE="PIGM01_002CTDX002R00";

# Run the FileSource driver, opening the data file at /Ross/Projects/IOOS/PacIOOS/Data
# and to the RBNB server @ bbl.ancl.hawaii.edu:3333, defining the source name as
# 'PIGM01_002CTDX002R00' and the data channel as 'DecimalASCIISampleData'.  The 
...
# CTD instrument (15/hour), which equates to about 65 bytes of data per frame,
# depending on the CTD configuration. With this ring buffer request, this source
# use approximately 8.2MB of RAM, and 2.05GB of disk storage (in a 1 year period).
...
# 23.6937,  3.83534,         ,0.0997, 0.0870,  25.0724, 06 Mar 2010 11:04:50
#
...
java edu.hawaii.soest.kilonalu.utilities.FileSource\
 -F "/Ross/Projects/IOOS/PacIOOS/Data/GUAM/Downloads/Guam.txt"\
