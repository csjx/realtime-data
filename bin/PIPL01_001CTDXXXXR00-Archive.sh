...
# @ 127.0.0.1:3333, reading from the source named 'PIPL01_001CTDXXXXR00' and the 
# data channel 'BinaryPD0EnsembleData'.  The client is also setting the sink 
# name to be 'PIPL01_001CTDXXXXR00_DecimalASCIIData_FileArchiver', and is
# setting the archive directory to be
# '/data/rbnb/PIPL01_001CTDXXXXR00/DecimalASCIISampleData'.  The sink client
