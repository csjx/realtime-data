...
export SOURCE="PIAS01_001CTDXXXXR00";

# run the FileArchiverSink client, connecting to the RBNB server 
# @ 127.0.0.1:3333, reading from the source named 'PIAS01_001CTDXXXXR00' and the 
# data channel 'BinaryPD0EnsembleData'.  The client is also setting the sink 
# name to be 'PIAS01_001CTDXXXXR00_DecimalASCIIData_FileArchiver', and is
# setting the archive directory to be
# '/data/rbnb/PIAS01_001CTDXXXXR00/DecimalASCIISampleData'.  The sink client
