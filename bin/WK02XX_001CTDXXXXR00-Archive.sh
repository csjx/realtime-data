...
# @ 127.0.0.1:3333, reading from the source named 'WK02XX_001CTDXXXXR00' and the 
# data channel 'BinaryPD0EnsembleData'.  The client is also setting the sink 
# name to be 'WK02XX_001CTDXXXXR00_DecimalASCIIData_FileArchiver', and is
# setting the archive directory to be '
# '/data/rbnb/WK02XX_001CTDXXXXR00/DecimalASCIISampleData'.  The sink client
...
java edu.hawaii.soest.kilonalu.utilities.FileArchiverSink\
 -s 192.168.103.50\
 -p 3333\
 -n WK02XX_001CTDXXXXR00\
 -c DecimalASCIISampleData\
 -k WK02XX_001CTDXXXXR00_DecimalASCIIData_FileArchiver\
 -d /data/raw/alawai/WK02XX_001CTDXXXXR00/DecimalASCIISampleData
