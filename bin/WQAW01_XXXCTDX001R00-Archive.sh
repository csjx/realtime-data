...
# @ 192.168.103.50:3333, reading from the source named 'WQAW01_XXXCTDX001R00' and the 
# data channel 'DecimalASCIISampleData'.  The client is also setting the sink 
# name to be 'WQAW01_XXXCTDX001R00_DecimalASCIIData_FileArchiver', and is
# setting the archive directory to be '
# '/data/rbnb/WQAW01_XXXCTDX001R00/DecimalASCIISampleData'.  The sink client
...
java edu.hawaii.soest.kilonalu.utilities.FileArchiverSink\
 -s 192.168.103.50\
 -p 3333\
 -n WQAW01_XXXCTDX001R00\
 -c DecimalASCIISampleData\
 -k WQAW01_XXXCTDX001R00_DecimalASCIIData_FileArchiver\
 -d /data/raw/alawai/WQAW01_XXXCTDX001R00/DecimalASCIISampleData
